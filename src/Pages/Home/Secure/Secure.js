...
const Secure = () => {
    return (
        <div className='w-1/2 mx-auto bg-red-100 mb-12'>
            <div>
            <h2 className='text-yellow-800 text-3xl text-center p-6 mt-12'>How to be secure</h2> 
 
            </div>
            <div>
            <div tabIndex={0} className=" mb-2 collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
...
<div tabIndex={1} className="mb-2 collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
  <div className="collapse-title text-xl font-medium">
    Don't pay first.
  </div>
  <div className="collapse-content"> 
...
<div tabIndex={2} className="mb-2 collapse collapse-arrow border border-base-300 bg-base-100 rounded-box">
  <div className="collapse-title text-xl font-medium">
    Don't meet alone .
  </div>
  <div className="collapse-content"> 
